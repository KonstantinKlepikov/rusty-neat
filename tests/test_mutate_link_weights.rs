...
fn randomize_and_mutate_weights() {
    ...
    g.push_neuron(crate::genes::NeuronGene::new(
        1,
    ...
    g.push_link(crate::genes::LinkGene::new(1, 2, 1, 0.5, false));

...
fn rtrl_update_weights_multiple_connections_applies_all_changes() {
    ...
    net.add_neuron(Neuron::new(NeuronType::Input, ActivationFunction::UnsignedSigmoid));
    net.add_neuron(Neuron::new(NeuronType::Hidden, ActivationFunction::UnsignedSigmoid));
    net.add_neuron(Neuron::new(NeuronType::Output, ActivationFunction::UnsignedSigmoid));
    net.set_input_output_dimensions(1, 1);

    // add multiple connections
    net.add_connection(Connection { source_neuron_idx: 0, target_neuron_idx: 1, weight: 0.1, signal: 0.0, recur_flag: false, hebb_rate: 0.0, hebb_pre_rate: 0.0 });
    net.add_connection(Connection { source_neuron_idx: 1, target_neuron_idx: 2, weight: -0.2, signal: 0.0, recur_flag: false, hebb_rate: 0.0, hebb_pre_rate: 0.0 });
    net.add_connection(Connection { source_neuron_idx: 0, target_neuron_idx: 2, weight: 0.0, signal: 0.0, recur_flag: false, hebb_rate: 0.0, hebb_pre_rate: 0.0 });
